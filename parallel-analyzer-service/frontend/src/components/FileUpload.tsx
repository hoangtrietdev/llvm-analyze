...
const FileUpload: React.FC<FileUploadProps> = ({
  ...
  if (selectedFile) {
    return (
      <div className="border-2 border-gray-600 border-dashed rounded-lg p-6 bg-gray-700">
  ...
  return (
    <div
      {...getRootProps()}
      className={`border-2 border-gray-600 border-dashed rounded-lg p-6 text-center cursor-pointer transition-colors bg-gray-700 ${
        isDragActive
